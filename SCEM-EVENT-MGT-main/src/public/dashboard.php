...
<head>
    ...
    <style>
        ...
        .events {
            ...
            height: calc(100vh - 120px); /* Adjust to make cards full page */
        }
        ...
        .event-image {
            width: 100%;
            height: 75%; /* Adjusted to 3:1 ratio */
            object-fit: cover;
        }

        .event-content {
            padding: 15px;
            height: 25%; /* Adjusted to 3:1 ratio */
        }
...
<body>
            ...
            <div class="event-card">
                ...
                <div class="event-content">
                    ...
                    <div class="event-description">
                        <?php echo htmlspecialchars(substr($event['event_description'], 0, 100)); ?>...</div>
    ...
    <script>
        ...
        function scrollEvents(direction) {
            ...
            eventsContainer.scrollTo({ left: scrollPosition, behavior: 'smooth' });
        }
